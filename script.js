...
// let cartItems=document.getElementById("cart_item");
...
// cartPopup.style.border="2px solid balck";
...
//     let price=Number(card.querySelector(".food_price").innerText)
// // });
...
//    cartPopup.innerHTML+=`<p>${item}*${qty}=<i class="fa-solid fa-indian-rupee-sign"></i>${qty*itemPrice.toFixed(2)}</p>`
...
let quantityBoxes=document.querySelectorAll(".food_quantity");
let cartIcon=document.querySelector(".fa-cart-shopping");
let cartItemsCount=document.getElementById("cart_item")
let cartprice=document.getElementById("price")
 
let cartPopup=document.createElement("div");
document.body.appendChild(cartPopup);
cartPopup.style.id="cart_popup";
cartPopup.style.backgroundColor="white";
// cartPopup.style.height="200px";
cartPopup.style.width="300px";
cartPopup.style.position="fixed";
